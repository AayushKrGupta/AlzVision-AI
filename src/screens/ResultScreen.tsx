...
export const ResultScreen = () => {
    ...
    const getResultData = () => {
        switch (result) {
            ...
            case "EMCI":
                return {
                    title: "Early Mild Cognitive Impairment",
                    color: "#FF9500",
                    description: "Mild signs detected. Early intervention recommended.",
                    recommendations: [
            ...
            case "LMCI":
                return {
                    title: "Late Mild Cognitive Impairment",
                    color: "#FF3B30",
                    description: "Significant signs detected. Medical attention advised.",
                    recommendations: [
            ...
            case "AD":
                return {
                    ...
                    color: "#FF3B30",
                    description: "High probability of Alzheimer's Disease.",
                    recommendations: [
